                    ...
                    <div className="window__container">
                        <div className="window__outer">
                            <div className="window__inner">
                                ...
                                <div className="bubble bubble--lg bubble--focus">
                                    <div ref="number" className="bubble__inner bubble__inner--pad">
                                        { answerAttempts >= 3 && currentMode !== 'Cheat' &&
                                            <p className="bubble__desc bubble__desc--offset-top bubble__desc--constrained"><strong>คำใบ้:</strong> { this.createClue(currentNumber.answerLanguage)  }</p>
                                        }
                                        { currentMode === 'Cheat' &&
                                            <p className="bubble__desc bubble__desc--offset-top bubble__desc--constrained"><strong>ตอบ:</strong> { currentNumber.answerLanguage }</p>
                                        }
                                ...
                                <input ref="input" type="text" className="window__form-control window__form-control--push window__form-control--wide zero-bottom" onKeyUp={ this.handleKeyUp } placeholder="แปลเลขจากอังกฤษเป็นไทย" autofocus></input>
                            </div>
                        </div>
                    </div>
                </div>
